...
Generated: 2026-05-17T04:00:20.283376+00:00
Probe mode: live
...
- /system-health: `ok=True` `http=200` `elapsed=4.452s`
- /learning-status: `ok=True` `http=200` `elapsed=0.453s`
- /risk-block-performance: `ok=True` `http=200` `elapsed=0.003s`
- /shadow-performance: `ok=True` `http=200` `elapsed=0.416s`
- /smart-money-backtest: `ok=True` `http=200` `elapsed=0.008s`
- /shadow-buy-review: `ok=True` `http=200` `elapsed=0.122s`
...
- /shadow-buy-failure-diagnosis: `ok=True` `http=200` `elapsed=0.199s`
- /strict-resume-shadow-simulation: `ok=True` `http=200` `elapsed=0.237s`
...
- paper_trades: `1`
- open_trades: `0`
- shadow_buy_count: `261`
- shadow_smart_money_count: `214`
...
- Runtime hard block reason: `master_dataset.csv is 81.38h old; max allowed is 36.00h; supervision_verdict=DO_NOT_RESUME_TRADING_OR_PAPER_TEST`
...
- Shadow BUYs: `261 / 100`
- Shadow Smart Money: `214 / 50`
- Ready for risk block review: `True`
- Ready for Smart Money review: `True`
- Shadow BUY review: `262 / 100` `SHADOW_BUY_STAYS_SHADOW`
- TA shadow progress: `95 / 50` ready_for_bonus=`False`
- AI TA shadow progress: `95 / 50` ready_for_bonus=`False`

## Learning-Only Scans

- Enabled: `True`
- Interval minutes: `60`
- Learning-only scans total: `234`
- Live paper scans total: `78`
- Last learning-only scan: `2026-05-17T03:00:17+00:00`
- Duplicate scans suppressed: `4`
- Claude calls from learning scans: `234`
- Estimated learning API cost daily: `$0.172552`
- Estimated learning API cost monthly: `$5.17656`
...
- BB squeeze: `{'count': 112, 'avg_return_1h': -0.0039, 'avg_return_4h': 0.013, 'avg_return_24h': -0.3548, 'blocked_winners_1h': 1, 'blocked_winners_4h': 4, 'blocked_winners_24h': 15, 'saved_losses_1h': 2, 'saved_losses_4h': 10, 'saved_losses_24h': 41, 'verdict': 'helping'}`

## Smart Money Performance

- Shadow count: `214`
- Ready for bonus: `True`
- Score distribution: `{'0-39': 3, '40-59': 49, '60-79': 197, '80-100': 30}`
- Bias distribution: `{'bullish': 138, 'bearish': 135, 'neutral': 6}`

## TA / AI TA Shadow Layers

- TA enabled: `True` shadow_only=`True`
- TA shadow count: `95`
- TA avg future return 4h: `0.0962`
- AI TA enabled: `True` shadow_only=`True`
- AI TA calls total: `202`
- AI TA shadow count: `95`
- AI TA avg future return 4h: `0.0962`
